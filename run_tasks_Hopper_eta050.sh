...
# # finish eta = 0.050
# nohup python -u Fed_HAPG.py --global-iteration 150 --env Hopper --beta 0.0 --num-agent 2 --eta 0.050 > ./outerr/Fed_HAPG_Hopper_0p0_gi150_a2_eta050.out 2> ./outerr/Fed_HAPG_Hopper_0p0_gi150_a2_eta050.err &
# pid0=$!

# # 休息30mins
# sleep 20

# nohup python -u Fed_HAPG.py --global-iteration 150 --env Hopper --beta 0.1 --num-agent 2 --eta 0.050 > ./outerr/Fed_HAPG_Hopper_0p1_gi150_a2_eta050.out 2> ./outerr/Fed_HAPG_Hopper_0p1_gi150_a2_eta050.err &
# pid1=$!
